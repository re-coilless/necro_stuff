...
for i,id in pairs( EntityGetInRadiusWithTag( pos_x, pos_y, range, "enemy" )) do
	if( id == EntityGetRootEntity( id )) then
		...
		GameCreateSpriteForXFrames( "mods/necro_stuff/files/gui/radar_enemy_"..tp..".png", x, y, true, 0, 0, 1, true )
	end
end
